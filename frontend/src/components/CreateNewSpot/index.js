...
const handleSubmit = (e) => {
    ...
    return (
      ...
      */}
        ...
        <input className="create-house-input" type="number" min="1" placeholder="price" pattern='[0-9]+(\\.[0-9][0-9]?)?' value={price} onChange={(e)=>{setPrice(e.target.value)}} required ></input>

...
// }
    ...
    return (
        ...
        {spot.SpotImages.map((image)=>{return(
            <div key={image.id}>
            <img src={image.url}/>
            {/* <img id="currentPhoto" src="SomeImage.jpg" onError={imageerrorHandler} />
            <img id="currentPhoto" src="SomImage.jpg" onError={imageerrorHandler} />
            <img id="currentPhoto" src="SomeImag.jpg" onError={imageerrorHandler} />
            <img id="currentPhoto" src="SomeImag.jpg" onError={imageerrorHandler} /> */}
            </div>
        )})}
        </div> }
